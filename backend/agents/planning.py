...
## 出典の記載ルール
- 具体的な数値・統計・市場規模を記載する際は、その直後に出典をインラインで示す
  URLがある場合: <a href="URL" target="_blank" class="text-xs text-blue-500 underline ml-1">出典</a>
  URLがない場合: <span class="text-xs text-gray-400 ml-1">（出典: 〇〇）</span>
- 推定値には必ず「（※推定）」を付記する
